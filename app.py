...
st.markdown("""
<style>
:root{--navy:#155268;--deep:#103f54;--coral:#ff7d6d;--turquoise:#10c7b2;--yellow:#ffc95f;--ice:#edf9f8;--cyan:#10aeb5;--green:#059669;--amber:#d97706;--red:#dc2626;--line:#d9e3e4}
.stApp{background:radial-gradient(circle at 92% 3%,rgba(16,199,178,.10),transparent 25rem),#f4f6f5}
.block-container{max-width:1500px;padding-top:1rem}.hero{position:relative;overflow:hidden;background:linear-gradient(112deg,var(--deep),var(--navy));padding:1.45rem 1.8rem;border-radius:18px;color:white;border-left:10px solid var(--coral);box-shadow:0 12px 30px rgba(16,63,84,.18)}
.hero:after{content:"❄";position:absolute;right:2rem;top:-1.8rem;font-size:9rem;color:rgba(16,199,178,.19)}.hero small{color:var(--yellow);font-weight:800;letter-spacing:.16em}.hero h1{color:white;margin:.2rem 0;font-size:2.15rem}.hero p{color:#e7fbf8;margin:.35rem 0 0}
.cards{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:11px;margin:1rem 0}.card{background:var(--accent);border:0;border-radius:15px;padding:.9rem;box-shadow:0 8px 18px rgba(21,82,104,.12);min-height:118px}.cards .card:nth-child(1),.cards .card:nth-child(5){background:linear-gradient(135deg,#ff8b79,var(--coral))}.cards .card:nth-child(2),.cards .card:nth-child(4),.cards .card:nth-child(6){background:linear-gradient(135deg,#20d1bd,#08afac)}.cards .card:nth-child(3){background:linear-gradient(135deg,#ffd779,var(--yellow))}.label{font-size:.73rem;color:rgba(255,255,255,.88);font-weight:800;letter-spacing:.025em;text-transform:uppercase;min-height:2.15em}.value{font-size:1.65rem;color:white;font-weight:900}.hint{font-size:.68rem;color:rgba(255,255,255,.88);font-weight:700}.cards .card:nth-child(3) .label,.cards .card:nth-child(3) .value,.cards .card:nth-child(3) .hint{color:#4f4750}
.module-note{background:linear-gradient(90deg,#e5faf7,#fff8e6);border:1px solid #cce8e5;border-left:6px solid var(--coral);border-radius:12px;padding:.72rem .95rem;margin:.55rem 0;color:#274b63}
.decision-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin:.8rem 0 1rem}.decision{background:#fff;border:2px solid #c9dadd;border-radius:16px;padding:1rem;box-shadow:0 6px 18px rgba(25,70,100,.06)}.decision:nth-child(1){border-top:7px solid var(--coral)}.decision:nth-child(2){border-top:7px solid var(--turquoise)}.decision:nth-child(3){border-top:7px solid var(--yellow)}.decision h4{margin:.35rem 0;color:#183b56}.decision p{margin:.2rem 0;color:#52677a;font-size:.86rem}.badge{display:inline-block;border-radius:999px;padding:.22rem .55rem;font-size:.72rem;font-weight:800}.critical{background:#fee2e2;color:#991b1b}.high{background:#ffedd5;color:#9a3412}.watch{background:#fef3c7;color:#854d0e}.good{background:#ccfbf1;color:#115e59}
...
[data-testid="stSidebar"]{background:linear-gradient(180deg,var(--deep),var(--navy));border-right:0}[data-testid="stSidebar"] h2,[data-testid="stSidebar"] label,[data-testid="stSidebar"] [data-testid="stCaptionContainer"]{color:#f4fbfb!important}[data-testid="stSidebar"] hr{border-color:rgba(255,255,255,.18)}[data-testid="stSidebar"] .stButton button{background:var(--coral);color:white;border:0}[data-testid="stSidebar"] [data-baseweb="select"]>div{background:white;border-color:rgba(255,255,255,.25)}
